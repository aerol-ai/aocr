...
description: 'Navigate the aocr repository. Use when you need to find where auth, hooks, reaper, web, registry, database, Helm, Ansible, CI, docs, or tests live, or when deciding which files own a behavior.'
---
...
3. Prefer `auth/src/**`, `hooks/src/**`, `hooks/test/**`, `web/src/**`, `db/**`, and `helm/aocr/**`.
